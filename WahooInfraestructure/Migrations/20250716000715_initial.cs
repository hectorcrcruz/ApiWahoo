    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, new DateTime(2025, 7, 15, 19, 7, 14, 662, DateTimeKind.Local).AddTicks(484), null, "Colombia", "Sistema", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "Error al asignar el domicilio", 2, null, null, "Sistema", null },
                    { 3, 3, "Se debe seleccionar un ingrediente para el pedido", 2, null, null, "Sistema", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "ApellidoUsuario", "CausacionPagos", "Circulacion", "Correo", "DireccionUsuario", "Documentos", "Estado", "ExpedicionCedula", "FechaAdd", "FechaUp", "FormaPago", "HorarioUsuario", "ImagenUsuario", "LicenciaConduccion", "Login", "NombreUsuario", "Password", "PlacaMoto", "RolId", "TelefonoUsuario", "TipoIdentificacionId", "Token", "UsuarioAdd", "UsuarioUp" },
                values: new object[,]
                {
                    { 1, "Cruz", "Diario", 1, "hcruz5785@gmail.com", "KR 109 A # 151 - 09", "documento.jpg", 2, new DateTime(2016, 11, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, 1, 1, "", "SDHSDF", "1049655475", "Hector", "147258963***", "FUG321", 1, "3219856584", 2, null, "Sistema", null },
                    { 2, "Vargas", "Mensual", 1, "hcruz5785@gmail.com", "KR 95 A # 92 - 64", "documento.png", 2, new DateTime(2013, 11, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, 2, 1, "", "WHDGS", "123456789", "Cristian", "147258963*1*", "BGE587", 2, "3123960059", 2, null, "Sistema", null },
                    { 3, "Ospina", "Quincenal", 1, "hcruz5785@gmail.com", "KR 97 A # 92 - 09", "documento.pdf", 2, new DateTime(2010, 11, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, 3, 1, "", "GEGSWFFS", "987654321", "Juan Pablo", "147**2*", "TTE432", 3, "3103232316", 2, null, "Sistema", null }
                });

            migrationBuilder.InsertData(
                table: "Calificaciones",
                columns: new[] { "Id", "CriterioEvaluacionId", "Estado", "FechaAdd", "FechaUp", "ParametroEvaluacionId", "PuntajeCalificacion", "UsuarioAdd", "UsuarioId", "UsuarioUp" },
                values: new object[,]
                {
                    { 1, 1, 2, null, null, 1, 10, "Sistema", 1, null },
                    { 2, 2, 2, null, null, 2, 9, "Sistema", 2, null },
                    { 3, 3, 2, null, null, 3, 5, "Sistema", 3, null }
                });
