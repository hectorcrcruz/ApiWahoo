    ...
    public class WahooDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Producto>().HasData(
                new Producto { Id = 1, DescripcionProducto = "Langosta a las finas hierbas", DetalleProducto = "Langosta de 600 gramos con salsas", CategoriaProductoId = 1, stock = 10, ValorProducto = 120000, ImagenProducto = "https://appwahoostorage.blob.core.windows.net/appwahooimages/LangostaFinasHierbas.png", UsuarioAdd = "Sistema", Estado = 2 },
                new Producto { Id = 2, DescripcionProducto = "Hamburgesa", DetalleProducto = "Hamburgesa doble carne, con huevo y salsa de la casa", CategoriaProductoId = 1, stock = 5, ValorProducto = 25000, ImagenProducto = "https://appwahoostorage.blob.core.windows.net/appwahooimages/Hamburguessa.png", UsuarioAdd = "Sistema", Estado = 2 },
                new Producto { Id = 3, DescripcionProducto = "Cerveza Modelo", DetalleProducto = "Caja de cervezas de 6 unidades", CategoriaProductoId = 1, stock = 12, ValorProducto = 90000, ImagenProducto = "https://appwahoostorage.blob.core.windows.net/appwahooimages/CervezaModelo.png", UsuarioAdd = "Sistema", Estado = 2 }
                );

            modelBuilder.Entity<Promocion>().HasData(
                new Promocion { Id = 1, DescripcionPromocion = "2x1", ProductoId = 1, TipoPromocionId = 1, FechaInicioPromocion = Convert.ToDateTime("2025-04-24"), FechaFinPromocion = Convert.ToDateTime("2025-04-27"), CodigoPromocional = "AAA123", ImagenPrimariaPromocion = "https://appwahoostorage.blob.core.windows.net/appwahooimages/Promocion1.jpg", ImagenSecundariaPromocion = "https://appwahoostorage.blob.core.windows.net/appwahooimages/Promocion1.jpg", UsuarioAdd = "Sistema", Estado = 2 },
                new Promocion { Id = 2, DescripcionPromocion = "Por tiempo limitado", ProductoId = 2, TipoPromocionId = 2, FechaInicioPromocion = Convert.ToDateTime("2025-04-24"), FechaFinPromocion = Convert.ToDateTime("2025-04-27"), CodigoPromocional = "ABC123", ImagenPrimariaPromocion = "", ImagenSecundariaPromocion = "", UsuarioAdd = "Sistema", Estado = 2 },
                new Promocion { Id = 3, DescripcionPromocion = "Descuento Especial", ProductoId = 3, TipoPromocionId = 3, FechaInicioPromocion = Convert.ToDateTime("2025-04-24"), FechaFinPromocion = Convert.ToDateTime("2025-04-27"), CodigoPromocional = "BCA123", ImagenPrimariaPromocion = "", ImagenSecundariaPromocion = "", UsuarioAdd = "Sistema", Estado = 2 }
            );
